...
def initIMU():
    ...
    writeByte(0x6A,0x10,0b10011111)         #ODR 3.33 kHz, +/- 8g , BW = 400hz
    writeByte(0x6A,0x17,0b11001000)         #Low pass filter enabled, BW9, composite filter
    writeByte(0x6A,0x12,0b01000100)         #Enable Block Data update, increment during multi byte read

    #initialise the gyroscope
    writeByte(0x6A,0x11,0b10011100)         #ODR 3.3 kHz, 2000 dps

    #initialise the magnetometer
    writeByte(0x1C,0x20, 0b11011100)        # Temp sesnor enabled, High performance, ODR 80 Hz, FAST ODR disabled and Selft test disabled.
    writeByte(0x1C,0x21, 0b00100000)        # +/- 8 gauss
    writeByte(0x1C,0x22, 0b00000000)        # Continuous-conversion mode
